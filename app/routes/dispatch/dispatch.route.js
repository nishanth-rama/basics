...
module.exports = (app) => {
  ...
  router.get(
    "/v1/get_SKU_based_SO_type",
    requireAuth,
    dispatchController.get_so_type
  );

  router.get(
    "/v1/get_STOPO_based_SO_picking_qty",
    requireAuth,
    dispatchController.get_STOPO_picking_qty_listV2
  );

  router.get(
    "/v1/get_STOPO_based_PO_list",
    requireAuth,
    dispatchController.get_STOPO_based_po_list
  );
